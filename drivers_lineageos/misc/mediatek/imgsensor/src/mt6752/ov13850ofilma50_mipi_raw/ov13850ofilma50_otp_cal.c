...
#include "ov13850ofilma50mipiraw_Sensor.h"
#include "ov13850ofilma50_otp.h"

#define PFX "OV13850OFILMA50_R2A_OTP"
...
int ov13850ofilma50r2a_update_eeprom()
{
...
bool ov13850ofilma50_otp_check_mid(void)
{
  u32 mid = 0x00;
  u32 OTP_SENSOR_MID=0,VCM_ID=0;
  TRACE("ov13850ofilma50_otp_check_mid start\n");    
  ...
  if ((OTP_SENSOR_MID==0x07)  && (VCM_ID==0x04))//sunnny =0x01,,OFLIM=0x07,VCM_ID :OFILM A40=0x08,OFILM A50=0x04,
  {
    return TRUE;
  }
  else
